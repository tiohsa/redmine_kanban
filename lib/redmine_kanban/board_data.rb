module RedmineKanban
  class BoardData
    LABEL_TRANSLATION_KEYS = {
      ...
      help: :label_kanban_help,
      help_chapter1_title: :label_kanban_help_chapter1_title,
      help_chapter1_desc: :label_kanban_help_chapter1_desc,
      help_add: :label_kanban_help_add,
      help_filter: :label_kanban_help_filter,
      help_assignee: :label_kanban_help_assignee,
      help_project: :label_kanban_help_project,
      help_status: :label_kanban_help_status,
      help_priority: :label_kanban_help_priority,
      help_due: :label_kanban_help_due,
      help_sort: :label_kanban_help_sort,
      help_priority_lane: :label_kanban_help_priority_lane,
      help_time_entry: :label_kanban_help_time_entry,
      help_viewable_projects: :label_kanban_help_viewable_projects,
      help_fit_mode: :label_kanban_help_fit_mode,
      help_show_subtasks: :label_kanban_help_show_subtasks,
      help_fullscreen: :label_kanban_help_fullscreen,
      help_scroll_top: :label_kanban_help_scroll_top,
      help_font_size: :label_kanban_help_font_size,
      help_chapter2_title: :label_kanban_help_chapter2_title,
      help_drag_drop_title: :label_kanban_help_drag_drop_title,
      help_drag_drop_desc: :label_kanban_help_drag_drop_desc,
      help_edit_title: :label_kanban_help_edit_title,
      help_edit_desc: :label_kanban_help_edit_desc,
      help_quick_edit_title: :label_kanban_help_quick_edit_title,
      help_quick_edit_desc: :label_kanban_help_quick_edit_desc,
      help_subtask_title: :label_kanban_help_subtask_title,
      help_subtask_desc: :label_kanban_help_subtask_desc
    }.freeze
