    ...
    def labels
      {
        ...
        reset: l(:label_kanban_reset),
        undo: l(:label_kanban_undo),
        restoring: l(:label_kanban_restoring),
        bulk_subtask_title: l(:label_kanban_bulk_subtask_title),
        bulk_subtask_placeholder: l(:label_kanban_bulk_subtask_placeholder),
        bulk_subtask_help: l(:label_kanban_bulk_subtask_help),
        creating: l(:label_kanban_creating),
        created: l(:label_kanban_created),
        saving: l(:label_kanban_saving),
        saved: l(:label_kanban_saved),
        save: l(:label_kanban_save),
        create: l(:label_kanban_create),
        show_subtasks: l(:label_kanban_show_subtasks),
        hide_subtasks: l(:label_kanban_hide_subtasks),
        board_aria: l(:label_kanban_board_aria),
        subtask_update_failed: l(:label_kanban_subtask_update_failed),
        restore_failed: l(:label_kanban_restore_failed),
        restore_error: l(:label_kanban_restore_error),
        updated: l(:label_kanban_updated),
        created_with_subtasks: l(:label_kanban_created_with_subtasks),
        updated_with_subtasks: l(:label_kanban_updated_with_subtasks),
        created_subtask_failed: l(:label_kanban_created_subtask_failed),
        updated_subtask_failed: l(:label_kanban_updated_subtask_failed),
        deleted_with_undo: l(:label_kanban_deleted_with_undo),
        url_clickable: l(:label_kanban_url_clickable),
        filter: l(:label_kanban_filter),
        filter_task: l(:label_kanban_filter_task),
        filter_subject: l(:label_kanban_filter_subject),
        project: l(:label_kanban_project),
