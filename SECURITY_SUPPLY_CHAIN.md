...
This repository uses JavaScript/TypeScript tooling in the frontend, so dependency and CI integrity must be treated as part of the security boundary.

## Required practices

- Use the committed lockfile when installing dependencies.
- Prefer `pnpm install --frozen-lockfile` for this frontend.
